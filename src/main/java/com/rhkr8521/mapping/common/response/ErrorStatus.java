...
public enum ErrorStatus {
    ...
    FAIL_UNLINK_OAUTH2_EXCEPTION(HttpStatus.INTERNAL_SERVER_ERROR,"OAuth 연결 해제 실패:"),
    MISSING_OAUTH_REFRESH_TOKEN(HttpStatus.INTERNAL_SERVER_ERROR,"OAuth2 리프레시 토큰이 존재하지 않습니다."),
